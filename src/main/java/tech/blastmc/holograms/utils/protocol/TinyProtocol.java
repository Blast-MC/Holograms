...
import tech.blastmc.holograms.utils.protocol.Reflection.MethodInvoker;
...
public abstract class TinyProtocol {
	...
	private static final FieldAccessor<Object> getConnection = Reflection.getField("{nms}.level.EntityPlayer", "b", Object.class);
	private static final FieldAccessor<Object> getManager = Reflection.getField("{nms}.network.PlayerConnection", "h", Object.class);
	private static final FieldAccessor<Channel> getChannel = Reflection.getField("net.minecraft.network.NetworkManager", Channel.class, 0);

	// Looking up ServerConnection
	private static final Class<Object> minecraftServerClass = Reflection.getUntypedClass("{nms}.MinecraftServer");
	private static final Class<Object> serverConnectionClass = Reflection.getUntypedClass("{nms}.network.ServerConnection");
	...
	private static final Class<?> PACKET_LOGIN_IN_START = Reflection.getClass("net.minecraft.network.protocol.login.PacketLoginInStart");
	private static final FieldAccessor<Optional> getGameProfile = Reflection.getField(PACKET_LOGIN_IN_START, Optional.class, 0);
	...
	private final class PacketInterceptor extends ChannelDuplexHandler {
		...
		private void handleLoginStart(Channel channel, Object packet) {
			if (PACKET_LOGIN_IN_START.isInstance(packet)) {
				Object object = getGameProfile.get(packet).orElse(null);
				if (object == null)
					return;
				GameProfile profile = new GameProfile(UUID.fromString(object.toString()), getName.get(packet));
